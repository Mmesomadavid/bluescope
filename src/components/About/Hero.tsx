    ...
    <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-blue-700 to-blue-50/10 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-start text-left max-w-4xl">
          ...
          >
           Breakthrough in Investment: <br /> Unlocking Real Assets Through Tokenization
          </motion.h1>
          ...
          >
            Bluesteel Pty Ltd is committed to redefining how individuals and enterprises approach asset transformation. We turn potential into progress, bridging innovation with practical solutions that drive sustainable growth.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
