    ...
    <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-blue-700 to-blue-50/10 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-start text-left mb-12 max-w-6xl">
          ...
          >
            Breakthrough in Investment:  Unlocking Real   Assets Through  <span className="text-blue-700 font-bold">Tokenization</span>
          </motion.h1>
          ...
          >
            Bluesteel Pty Ltd is committed to redefining how individuals and enterprises approach asset transformation. 
            We turn potential into progress, bridging innovation with practical solutions that drive sustainable growth.
          </motion.p>
