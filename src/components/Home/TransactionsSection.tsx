      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-4">
            Bluescopepty LTD Recent Bulk Transactions
          </h2>
          <p className="text-sm sm:text-base text-gray-600 max-w-3xl">
            Track the latest transactions processed through our platform. Our transparent approach allows you to view
            real-time activity across our investment ecosystem.
          </p>
        </motion.div>
