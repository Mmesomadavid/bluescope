    ...
    <section id="philanthropy" className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-4 sm:p-6">
              <h3 className="text-white text-lg sm:text-xl font-bold mb-1 sm:mb-2">Building Better Communities</h3>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-[#1e56ff] text-white p-6 sm:p-8 md:p-12 rounded-lg text-center"
        >
          <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Join Us in Making a Difference</h3>
          ...
          <Link
            ...
            className="inline-flex items-center bg-white text-[#1e56ff] px-6 sm:px-8 py-2 sm:py-3 rounded-md text-sm sm:text-base font-medium hover:bg-gray-100 transition-colors"
          >
