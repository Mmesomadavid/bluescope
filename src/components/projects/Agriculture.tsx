        ...
        >
          <motion.div className="bg-white p-6 rounded-lg shadow-sm" variants={itemVariants}>
            ...
            <p className="text-gray-700">
              ...
              food security. To capitalize on growth opportunities, Australia seeks investment in innovation,
              agriculture production, and advanced food processing, positioning itself as a key player in the global
              food market.
            </p>
          </motion.div>
          ...
          <motion.div className="bg-white p-6 rounded-lg shadow-sm" variants={itemVariants}>
            ...
            <p className="text-gray-700">
              ...
              destination for investors in agribusiness and food industries. With a transparent regulatory framework and
              strong trade ties to the Asia-Pacific region, investors benefit from Australia's network of free trade
              agreements.
            </p>
          </motion.div>
          ...
          <motion.div className="bg-white p-6 rounded-lg shadow-sm" variants={itemVariants}>
            ...
            <p className="text-gray-700">
              ...
              demand for safe, premium food products and integration into regional supply chains. Agribusiness presents
              significant opportunities for economic growth, emphasizing the importance of international partnerships.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="bg-white p-8 rounded-lg border border-gray-200">
            ...
            <p className="text-gray-700 mb-6">
              ...
              paper on developing northern Australia, the government aims to bolster supply chains, invest in research
              for productivity growth, and expand overseas markets.
            </p>
