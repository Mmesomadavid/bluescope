    ...
    <section id="oil-gas" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-4xl font-bold mb-2">Oil & Gas</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
              <h3 className="text-white text-xl font-bold mb-2">Energy Solutions</h3>
              <p className="text-white/80">Powering Australia's future with responsible energy production</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              Oil remained the largest primary energy source in Australia, at 38 per cent in 2013–14. Gas is Australia's
              third largest energy resource after oil and coal, accounting for 24 per cent. By the end of the decade,
              Australia should be home to ten operational LNG projects with a combined nameplate capacity of 86 million
        ...
        >
          <motion.div className="bg-gray-50 p-6 rounded-lg" variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-4">Conventional Gas</h3>
          ...
          <motion.div className="bg-gray-50 p-6 rounded-lg" variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-4">Oil Resources</h3>
            <p className="text-gray-700 mb-4">
              Australia's oil resources are primarily condensate and naturally occurring liquefied petroleum gas (LPG)
              associated with large offshore gas fields. Australia also has a number of crude oil reserves. There is
              scope for growth in Australia's oil reserves in existing fields, and for new oil discoveries in proven
              basins and in underexplored frontier basins.
            </p>
            <p className="text-gray-700">
              Australia has large unconventional oil resources hosted in oil shales. These resources, along with the
              recently recognised potential for shale gas liquids and light tight oil, could potentially contribute to
              future oil supply. Identified shale oil resources contained in immature oil shale deposits is estimated at
              131,659 petajoules (22,391 MMbbl).
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100" variants={itemVariants}>
            <Droplet className="h-10 w-10 text-[#1e56ff] mb-4" />
            <h3 className="text-xl font-bold mb-3">LNG Exports</h3>
            <p className="text-gray-700">
              Australia remained the world's third largest LNG exporter in 2014 and accounted for 10 per cent of world
              LNG trade. The strongest growth in Australia's export earnings will be in LNG, which is projected to
              increase from 23.2 million tonnes in 2013–14 to about 80 million tonnes in 2019–20.
            </p>
          </motion.div>

          <motion.div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100" variants={itemVariants}>
            <Flame className="h-10 w-10 text-[#1e56ff] mb-4" />
            <h3 className="text-xl font-bold mb-3">Global Demand</h3>
            <p className="text-gray-700">
              The growing global demand for energy, led mainly by China and India over the past decade, coupled with the
              shift in energy transition has driven a strong increase in gas demand, particularly LNG due to its
          ...
          <motion.div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100" variants={itemVariants}>
            ...
            <p className="text-gray-700">
              By the end of this decade Australia is expected to be the world's largest LNG exporter, generating
