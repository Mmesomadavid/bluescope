    ...
    <section id="mining" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-4xl font-bold mb-2">Mining</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
              <h3 className="text-white text-xl font-bold mb-2">Sustainable Mining Practices</h3>
              <p className="text-white/80">Committed to responsible resource extraction and community development</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <motion.div className="bg-gray-50 p-6 rounded-lg" variants={itemVariants}>
            <Users className="h-10 w-10 text-[#1e56ff] mb-4" />
          ...
          <motion.div className="bg-gray-50 p-6 rounded-lg" variants={itemVariants}>
            <Shield className="h-10 w-10 text-[#1e56ff] mb-4" />
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-[#1e56ff] text-white p-8 md:p-12 rounded-lg"
        >
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 mr-2 mt-0.5 text-white" />
