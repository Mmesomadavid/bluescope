    ...
    <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-blue-700 to-blue-50/10 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-start text-left max-w-4xl">
          ...
          >
            At Bluesteel Pty Ltd, we are dedicated to revolutionizing the landscape of asset transformation through purpose-driven projects. Each initiative is a step toward unlocking potential, bridging cutting-edge innovation with real-world application. Our project routes are strategically designed to deliver scalable, sustainable, and measurable impact — aligning client objectives with transformative outcomes.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
