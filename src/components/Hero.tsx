      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="flex flex-col items-center text-center">
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight uppercase mb-6"
          >
            Transforming <br />
            <span className="text-white/90">Assets into Opportunities</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-white/80 text-base sm:text-lg md:text-xl max-w-2xl mb-8"
          >
            We craft personalized solutions to support your business growth and take you one level closer to your goals.
          </motion.p>
